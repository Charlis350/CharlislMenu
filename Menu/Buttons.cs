    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Custom Menu Name", enableMethod = Settings.CustomMenuName, disableMethod =() => doCustomName = false, toolTip = $"Changes the name of the menu to whatever. You can change the text inside of your Gorilla Tag files ({PluginInfo.BaseDirectory}/Signal_CustomMenuName.txt)."},
                ...
                new ButtonInfo { buttonText = "Custom Font Type", enableMethod = Settings.CustomFontType, method = Settings.PersistCustomFont, disableMethod = Settings.DisableCustomFont, toolTip = $"Changes the font type on the menu to a custom font. You can change the photo inside of your Gorilla Tag files ({PluginInfo.BaseDirectory}/Signal_CustomWatermark.txt)."},
            ...
            new[] { // Important Mods [7]
                ...
                new ButtonInfo { buttonText = "Discord RPC", method = Important.DiscordRPC, disableMethod = Important.DisableDiscordRPC, toolTip = "Gives you a indicator on Discord that you are using the menu."},
            ...
            new[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Master Client Kick Gun", method = Overpowered.MasterClientKickGun, toolTip = "Kicks whoever your hand desires. Requires master client. Not bannable." },
                new ButtonInfo { buttonText = "Master Client Kick All", enableMethod = Overpowered.MasterClientKickAll, toolTip = "Kicks everyone from the room. Requires master client. Not bannable." },
                new ButtonInfo { buttonText = "Flood Lag Gun", method = Overpowered.FloodLagGun, toolTip = "Floods target with packets causing lag/crash. Works anywhere." },
                new ButtonInfo { buttonText = "Flood Lag All <color=grey>[</color><color=green>T</color><color=grey>]</color>", method = Overpowered.FloodLagAll, toolTip = "Floods everyone with packets when holding <color=green>trigger</color>. Works anywhere." },
            ...
            new[] { // Master Mods [16]
                ...
                new ButtonInfo { buttonText = "Spam Material All", method = Overpowered.SpamMaterialAll, toolTip = "Spams flashing materials on everyone. Requires master client."},

                new ButtonInfo { buttonText = "Ghost Gun <color=grey>[</color><color=green>Toggle</color><color=grey>]</color>", method = Overpowered.MasterGhostGun, toolTip = "Click to freeze a player. Click again to unfreeze. Everyone sees them frozen. Requires master."},
                new ButtonInfo { buttonText = "Ghost All", method = Overpowered.MasterGhostAll, isTogglable = false, toolTip = "Freezes everyone in place. Everyone sees them frozen. Requires master."},
                new ButtonInfo { buttonText = "Unghost All", method = Overpowered.MasterUnghostAll, isTogglable = false, toolTip = "Unfreezes everyone you ghosted. Requires master."},
                new ButtonInfo { buttonText = "Ghost Aura", method = Overpowered.MasterGhostAura, toolTip = "Freezes nearby players automatically. Requires master."},
            ...
            new[] { // Credits [38]
                ...
                new ButtonInfo { buttonText = "mojhehh", method =() => Process.Start("https://github.com/mojhehh"), isTogglable = false, toolTip = "mojhehh forked ii's Stupid Menu into this menu."},
                new ButtonInfo { buttonText = "iiDk (Original)", method =() => Process.Start("https://github.com/iiDk-the-actual"), isTogglable = false, toolTip = "iiDk is the original developer of ii's <b>Stupid</b> Menu, which this menu is forked from. All credit to him."},
...
new ButtonInfo { buttonText = "Flood Lag Gun", method =() => Overpowered.FloodLagGun(), toolTip = "Floods target with packets causing lag. Works anywhere." },
new ButtonInfo { buttonText = "Flood Lag All <color=grey>[</color><color=green>T</color><color=grey>]</color>", method =() => Overpowered.FloodLagAll(), toolTip = "Floods everyone with packets when holding <color=green>trigger</color>." },

new ButtonInfo { buttonText = "Master Client Kick Gun", method =() => Overpowered.MasterClientKickGun(), toolTip = "Kicks whoever your hand desires. Requires master client. Not bannable." },
new ButtonInfo { buttonText = "Master Client Kick All", enableMethod =() => Overpowered.MasterClientKickAll(), toolTip = "Kicks everyone from room. Requires master client. Not bannable." },
...
new ButtonInfo { buttonText = "Flood Lag Gun <color=grey>[</color><color=purple>Experimental</color><color=grey>]</color>", method =() => Overpowered.FloodLagGun(), toolTip = "Floods target with packets causing lag. Works anywhere." },
new ButtonInfo { buttonText = "Flood Lag All <color=grey>[</color><color=purple>Experimental</color><color=grey>]</color> <color=grey>[</color><color=green>T</color><color=grey>]</color>", method =() => Overpowered.FloodLagAll(), toolTip = "Floods everyone with packets when holding <color=green>trigger</color>." },
